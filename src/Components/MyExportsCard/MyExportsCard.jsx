...
const MyExportsCard = ({ d }) => {
  ...
  return (
    <div className="">
      <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 flex items-center justify-between px-6 py-4 mb-4 flex-col md:flex-row md:items-center gap-3 w-full md:w-auto">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Available Quantity:{" "}
              <span className="font-medium text-yellow-500">{stock}</span>
            </p>
          </div>
        </div>
